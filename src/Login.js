    ...
    return (
        <div className="login">
            ...
            <div className="login__container">
                ...
                <p>By signing in you agree to Tinbot's Conditions of Use & Sale. Please see our Privacy Notice, our Cookies.
                </p>

                <button onClick={register} className="login__registerButton">Create your tinder account</button>
            </div>
        </div>
    );
};
